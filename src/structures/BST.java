...
public class BST<T> {
	...
	public T getRoot() throws NoSuchElementException {
		if (isEmpty()) {
			throw new NoSuchElementException("getRoot: Cannot get root of empty tree");
		} else {
			return root.data;
		}
	}
	...
	public T findMin() throws NoSuchElementException {
		if (isEmpty()) {
			throw new NoSuchElementException("findMin: Cannot find minimum value of empty tree");
		} else {
			return findMin(root);
		}
	}
	...
	public T findMax() throws NoSuchElementException {
		if (isEmpty()) {
			throw new NoSuchElementException("findMax: Cannot find maximum of empty tree");
		} else {
			return findMax(root);
		}
	}
	 ...
	 * 
	 * @return a List of BST's value in order
	 */
	...
	/**
	 * Helper method for toListInOrder
	 * Does an in-order traversal of the tree and
	 * stores the values in the inOrderList field
	 */
